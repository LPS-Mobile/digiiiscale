        ...
        <div className="detail_wrapper">
            ...
            <div className="location_detail">
                ...
                <div className="call_wrapper">
                    <div className="call_btn"><Button>Call</Button></div>
                    <div className="call_cancel_btn"><Button>Cancel</Button></div>
                    <div className="pickup_btn" onClick={() => { setStep(4) }}><Button>Pickup</Button></div>
                </div>
            </div>
        </div>
    </>
