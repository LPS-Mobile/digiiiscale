...
import img from "../../../../public/images/blueDream.jpg"
        ...
        <div className="detail_wrapper">
            ...
            <div className="location_detail">
                <div className="location_detail_wrapper" style={{ border: "none" }}>
                    <span><svg fill="green" height={16} width={16} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" viewBox="0 0 31.955 31.955">
                        <g>
                    ...
                    <div>
                        ...
                        [Dispensary name] [Address] [Phone Number]
                    </div>

                </div>
                <div className="call_wrapper">
                    <div className="pickup_btn"><Button>Pickup</Button></div>
                </div>
                <div className="pickup_content">
                    <div>
                        <img src={img} alt="blueDream.jpg" />
                    </div>
                    <p className="">
                        1234
                    </p>
